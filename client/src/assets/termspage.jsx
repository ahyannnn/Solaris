...
const TermsPage = () => {
  return (
    <>
      <Helmet>
        <title>Terms and Conditions | Salfer Engineering</title>
      </Helmet>
      ...
      <div className="terms-page-wrapper">
        <div className="terms-page-container">
          ...
          <div className="terms-content">
            <h2>SOLARIS Solar Assessment and Planning System</h2>
            ...
            <div className="terms-section">
              <h3>3. Booking and Payment Policy</h3>
              ...
              <div className="terms-highlight-box">
                <strong>Assessment fee: prevailing fee shown at booking time (currently ₱1,500.00, subject to change by admin).</strong>
              </div>
            ...
            <div className="terms-section">
              ...
              <div className="terms-table-wrapper">
                <table className="terms-table">
                  <thead>
                    <tr>
                      <th>Timing of Cancellation</th>
                      <th>Refund Policy</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td>72 or more hours before scheduled deployment</td>
                      <td>80% refund</td>
                    </tr>
                    <tr>
                      <td>48 to 72 hours before scheduled deployment</td>
                      <td>50% refund</td>
                    </tr>
                    <tr>
                      <td>Less than 48 hours before scheduled deployment</td>
                      <td>No refund</td>
                    </tr>
                  </tbody>
                </table>
            ...
            <div className="terms-section">
              <h3>5. Weather and Environmental Conditions</h3>
            ...
            <div className="terms-section">
              <h3>6. Equipment Responsibility</h3>
            ...
            <div className="terms-section">
              <h3>7. Power and Connectivity Interruptions</h3>
            ...
            <div className="terms-section">
              <h3>8. Data Accuracy Disclaimer</h3>
            ...
            {/* 9. System Generated Designs */}
            <div className="terms-section">
              <h3>9. System Generated Designs and Layout Optimization</h3>
            ...
            <div className="terms-section">
              <h3>11. No Obligation to Purchase</h3>
            ...
            <div className="terms-section terms-section-last">
              <h3>16. Agreement Confirmation</h3>
          ...
          <div className="terms-footer">
            <p>© {new Date().getFullYear()} Salfer Engineering & Solar Technology Enterprise. All rights reserved.</p>
          </div>
        </div>
      </div>
    </>
