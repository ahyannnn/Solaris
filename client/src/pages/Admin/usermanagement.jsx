          ...
          <table className="users-table-usermgmtad-finalday">
            ...
            <tbody>
              {filteredUsers.length === 0 ? (
                <tr><td colSpan="8" className="empty-state-usermgmtad-finalday"><p>No users found</p></td></tr>
              ) : (
                filteredUsers.map(user => {
                  ...
                  return (
                    <tr key={user._id}>
                      ...
                      <td className="email-cell-usermgmtad-finalday"><FaEnvelope className="email-icon-usermgmtad-finalday" />{user.email}</td>
                      <td className="contact-cell-usermgmtad-finalday">{user.clientInfo?.contactNumber || '—'}</td>
                ...
                <div className="applicants-table-container-usermgmtad-finalday">
                  {loadingApplicants ? (
                    ...
                    <table className="applicants-table-usermgmtad-finalday">
                      ...
                      <tbody>
                        {filteredApplicants.length === 0 ? (
                          <tr><td colSpan={bulkImportMode ? 8 : 7} className="empty-state-usermgmtad-finalday"><p>No hired applicants found</p></td></tr>
                        ) : (
