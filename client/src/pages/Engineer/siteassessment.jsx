  ...
  const fetchAllEquipment = async () => {
    try {
      ...
      const [panelsRes, invertersRes, batteriesRes, mountingRes, electricalRes, cablesRes] = await Promise.all([
        axios.get(`${API_BASE_URL}/api/maintenance/config/equipment/solarPanels`, {
          headers: { Authorization: `Bearer ${token}` }
        }),
        axios.get(`${API_BASE_URL}/api/maintenance/config/equipment/inverters`, {
          headers: { Authorization: `Bearer ${token}` }
        }),
        axios.get(`${API_BASE_URL}/api/maintenance/config/equipment/batteries`, {
          headers: { Authorization: `Bearer ${token}` }
        }),
        axios.get(`${API_BASE_URL}/api/maintenance/config/equipment/mountingStructures`, {
          headers: { Authorization: `Bearer ${token}` }
        }),
        axios.get(`${API_BASE_URL}/api/maintenance/config/equipment/electricalComponents`, {
          headers: { Authorization: `Bearer ${token}` }
        }),
        axios.get(`${API_BASE_URL}/api/maintenance/config/equipment/cablesAndWiring`, {
          headers: { Authorization: `Bearer ${token}` }
        })
      ]);
  ...
  const fetchAllAssessments = async () => {
    try {
      ...
      const [freeQuotesRes, preAssessmentsRes] = await Promise.all([
        axios.get(`${API_BASE_URL}/api/free-quotes/engineer/my-quotes`, {
          headers: { Authorization: `Bearer ${token}` }
        }),
        axios.get(`${API_BASE_URL}/api/pre-assessments/engineer/my-assessments`, {
          headers: { Authorization: `Bearer ${token}` }
        })
      ]);
