...
router.get('/engineer/my-items', verifyToken, engineer, getEngineerItems);
router.get('/engineer/assessment-stats', verifyToken, engineer, getEngineerAssessmentStats);
